...
//    }
    ...
    public static int placeOrderDetail(OrderDetailTM orderDetail, String orderID) {
        try {
            Connection connection = DBConnection.getInstance().getConnection();
    ...
    public static int updateQty(OrderDetailTM orderDetailTM) {
        try {
            Connection connection = DBConnection.getInstance().getConnection();
            PreparedStatement pstm = connection.prepareStatement("UPDATE Item SET qtyOnHand=qtyOnHand-? WHERE code=?");
            pstm.setObject(1, orderDetailTM.getQty());
            pstm.setObject(2, orderDetailTM.getCode());
            return pstm.executeUpdate();
